...
@WebServlet(name = "QueryUnderConstructLineServlet")
public class QueryUnderConstructLineServlet extends HttpServlet {
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<Line> lines = service.queryUnderConstructLine();
        Gson gson=new Gson();
...
//            System.out.println("line   "+lineCoordinates);
//            linesResult.add(lineCoordinates);
//        }

//        String buslineInfo=gson.toJson(linesResult);
//        for(Line line:lines){
//            System.out.println(line.getId()+" "+line.getLineName());
//        }
        String buslineInfo = gson.toJson(lines);
