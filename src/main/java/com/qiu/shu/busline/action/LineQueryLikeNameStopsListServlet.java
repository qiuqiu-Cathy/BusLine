...
//根据首页公交名查询后返回所查询线路的stops的List<String>
public class LineQueryLikeNameStopsListServlet  extends HttpServlet {
...
//    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<String> stopsList = service.queryLineLikeNameStops(lineName);
        if(stopsList!=null){
            String stopsListInfo = gson.toJson(stopsList);
            System.out.println(stopsListInfo);
            out.write(stopsListInfo);
        } else{
            out.write("false");
        }
        out.close();
